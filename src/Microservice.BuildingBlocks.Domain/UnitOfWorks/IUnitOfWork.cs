namespace Microservice.BuildingBlocks.Domain.UnitOfWorks;
...
{
    /// <summary>
    /// Logical finish of a domain operation.
    ...
    /// <returns>Status of operation. TODO: Update to count of affected records.</returns>
